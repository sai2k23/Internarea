...
import JobData from '../Data/JobsDatAvl'
...
// due to this operation we need not to import the joddata through axios we allready stired in our db it just retrive our data by just import the axios //
useEffect(()=>{
...
fetchData();
    ...
    const filterInternSips=JobData.filter((item)=>
...
<span className={`category mr-4 ml-6 ${selectedCategory==="Data Science"?'bg-blue-500 text-white':""}`} onClick={()=>setSelectedCategory("Data Science")}>Data Science</span>
            ...
            <div className="internships" id='container3'>
              <div className="internShip-Info flex">
                  {
                  filterInternSips.map((data,index)=>(
