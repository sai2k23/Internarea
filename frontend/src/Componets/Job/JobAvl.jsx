...
useEffect(() => {
  ...
  return (
    ...
    <div className='flex internship-filter'>
     ...
     <p  className='text-center'><i class="bi bi-funnel text-center text-blue-400"></i> Filter</p>
     <div className='fill flex flex-col ml-2'>
 <label htmlFor='pro'>Profile</label>
 <input type="text" id='pro' value={serachCategory} onChange={handleCategoryChange} className='profile border-2 mr-3 w-full' placeholder='eg. profile manager'/>
 <label htmlFor="loc">Location</label>
<input type="text" id='loc' value={searchLoaction} onChange={handleCategoryLocationChange} className='location border-2  -ml-8 w-full' placeholder='eg. Mumbai'/>
 </div> 
    ...
    <div className="all-internships">
      ...
      { filterJob.map((data,index)=>(
         ...
         <div className='all-ele'>
                <div className='text-lg text-black m-2 mt-7'>{data.title}</div>
...
<p className='mt-3'>  <i class="bi bi-cash"></i> CTC <br /> {data.CTC}</p>

        </div>
         </div>
         <span className='bg-slate-200 text-slate-400 rounded-sm text-center'>Internship</span>
         <br />
         <span><i class="bi bi-stopwatch text-green-300"></i>25-07-24</span>
...
</div>
   {
    isDivVisible &&(
     ...
     <p className='text-center'><i onClick={showDiv} class="bi bi-funnel text-center text-blue-400"></i> Filter</p>
     <div className='fill flex flex-col ml-2'>
 <label htmlFor='pro'>Profile</label>
 <input type="text" id='pro' value={serachCategory} onChange={handleCategoryChange} className='profile border-2 mr-3 w-full' placeholder='eg. profile manager'/>
 <label htmlFor="loc">Location</label>
<input type="text" id='loc' value={searchLoaction} onChange={handleCategoryLocationChange} className='location border-2 mt-10 -ml-8 w-full' placeholder='eg. Mumbai'/>
 </div> 
     <div className='preferences mt-8 flex flex-col'>
  <div className="flex  mt-3 ml-3 mr-3">
       <input type="checkbox" name="wfh" id="whf" className='mr-2 ml-3'/>
